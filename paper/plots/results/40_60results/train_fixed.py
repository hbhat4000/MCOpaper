...
# Load data 40 and 60train_fixed.dat
for i in [40,60]:
    r = io.loadmat('%dtrain_fixed_new1'%i)
    model = r['model']
    ...
    plt.plot([0.001,4*val],[0.001,4*val],'r')
    plt.axis([0.001,4*val,0.001,4*val])
    ...
    plt.savefig('%dtrain_fixed_new1.eps'%i,format='eps',dpi=300)
